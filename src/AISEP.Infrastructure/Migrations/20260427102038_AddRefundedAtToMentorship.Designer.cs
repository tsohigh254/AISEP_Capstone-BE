...
namespace AISEP.Infrastructure.Migrations
{
    ...
    [Migration("20260427102038_AddRefundedAtToMentorship")]
    partial class AddRefundedAtToMentorship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.DocumentAccessLog", b =>
                {
                    b.Property<int>("LogID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.Incident", b =>
                {
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.InvestorPreferences", b =>
                {
                    ...
                    b.Property<string>("AcceptingConnectionsStatus")
                        .HasColumnType("text");

                    b.Property<string>("AiScoreImportance")
                        .HasColumnType("text");
                    ...
                    b.Property<float?>("PreferredAiScoreMax")
                        .HasColumnType("real");

                    b.Property<float?>("PreferredAiScoreMin")
                        .HasColumnType("real");

                    b.Property<string>("PreferredGeographies")
                        .HasColumnType("text");

                    b.Property<string>("PreferredIndustryIDs")
                        .HasColumnType("text");

                    b.Property<string>("PreferredMarketScopes")
                        .HasColumnType("text");

                    b.Property<string>("PreferredProductMaturity")
                        .HasColumnType("text");

                    b.Property<string>("PreferredStageIDs")
                        .HasColumnType("text");

                    b.Property<string>("PreferredStrengths")
                        .HasColumnType("text");

                    b.Property<string>("PreferredValidationLevel")
                        .HasColumnType("text");

                    b.Property<bool>("RecentlyActiveBadge")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireVerifiedStartups")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireVisibleProfiles")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.Stage", b =>
                {
                    b.Property<int>("StageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.Startup", b =>
                {
                    ...
                    b.Property<string>("FileCertificateBusiness")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RoleOfApplicant")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupAdvisorBookmark", b =>
                {
                    ...
                    b.HasIndex("StartupID", "AdvisorID")
                        .IsUnique()
                        .HasDatabaseName("IX_StartupAdvisorBookmarks_Unique");

                    b.ToTable("StartupAdvisorBookmarks");
                });
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupKycEvidenceFile", b =>
                {
                    b.Property<int>("EvidenceFileID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StartupKycEvidenceFiles");
                });

            modelBuilder.Entity("AISEP.Domain.Entities.StartupKycRequestedItem", b =>
                {
                    b.Property<int>("RequestedItemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("RequestedItemID"));
                    ...
                    b.ToTable("StartupKycRequestedItems");
                });

            modelBuilder.Entity("AISEP.Domain.Entities.StartupKycSubmission", b =>
                {
                    b.Property<int>("SubmissionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<short>("StartupVerificationType")
                        .HasColumnType("smallint");
                    ...
                    b.HasIndex("StartupID", "IsActive")
                        .HasFilter("\"IsActive\" = true");

                    b.HasIndex("StartupID", "Version")
                        .IsUnique();

                    b.ToTable("StartupKycSubmissions");
                });
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupReadinessSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StartupReadinessSnapshots");
                });
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupWallet", b =>
                {
                    b.Property<int>("WalletId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.WalletTransaction", b =>
                {
                    ...
                    b.Property<int?>("StartupWalletId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.Incident", b =>
                {
                    ...
                    b.HasOne("AISEP.Domain.Entities.User", "ResolvedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.InvestorIndustryFocus", b =>
                {
                    b.HasOne("AISEP.Domain.Entities.Industry", "IndustryRef")
                        .WithMany()
                        .HasForeignKey("IndustryID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.InvestorStageFocus", b =>
                {
                    ...
                    b.HasOne("AISEP.Domain.Entities.Stage", "StageRef")
                        .WithMany("InvestorStageFocuses")
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.Startup", b =>
                {
                    ...
                    b.HasOne("AISEP.Domain.Entities.Industry", "SubIndustryRef")
                        .WithMany()
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupKycEvidenceFile", b =>
                {
                    b.HasOne("AISEP.Domain.Entities.StartupKycSubmission", "Submission")
                        .WithMany("EvidenceFiles")
                        .HasForeignKey("SubmissionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupKycRequestedItem", b =>
                {
                    b.HasOne("AISEP.Domain.Entities.StartupKycSubmission", "Submission")
                        .WithMany("RequestedAdditionalItems")
                        .HasForeignKey("SubmissionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupWallet", b =>
                {
                    b.HasOne("AISEP.Domain.Entities.Startup", "Startup")
                        .WithOne()
                        .HasForeignKey("AISEP.Domain.Entities.StartupWallet", "StartupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("AISEP.Domain.Entities.StartupWallet", "StartupWallet")
                        .WithMany("Transactions")
                        .HasForeignKey("StartupWalletId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.Stage", b =>
                {
                    b.Navigation("InvestorStageFocuses");
            ...
            modelBuilder.Entity("AISEP.Domain.Entities.StartupKycSubmission", b =>
                {
                    ...
                    b.Navigation("RequestedAdditionalItems");
                });
